...
- CORRECTION — пользователь хочет ИЗМЕНИТЬ/ИСПРАВИТЬ статус блока ("поменяй на согласовано", "музыка уже утверждена", "поставь зелёный")
- GENERAL — всё остальное (приветствие, благодарность, болтовня, вопрос про другие проекты, "как дела?", "спасибо")
